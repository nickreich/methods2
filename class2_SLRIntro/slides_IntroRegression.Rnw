...
\bi
        \myitem A1: The model: e.g.  $\mathbb E[y_i|x_i] = f(x; \beta) +\epsilon_i= \beta_0 + \beta_1 x_1 + \epsilon_i$
	...
	\myitem A5: Probability distribution: e.g. $\epsilon_i \sim N(0, \sigma^2)$.
